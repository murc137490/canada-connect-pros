...
import { applyPwaIconTheme, readStoredBrandTier } from "./lib/pwaIconTheme";
...
// Restore last known tier immediately so Android doesn't flash B&W / wrong install icon.
applyPwaIconTheme(readStoredBrandTier());
