-- =============================================================================
-- Top Picks (top 3 per category) + Bookings table
-- Eligibility: 50+ valid bookings OR 40+ reviews. Run in Supabase SQL Editor.
-- =============================================================================

-- Bookings table (valid = completed)
...
-- Top 3 pros per category: eligible if (completed_bookings >= 50 OR review_count >= 40), ordered by avg_rating desc
