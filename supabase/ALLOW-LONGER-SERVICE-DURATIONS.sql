-- Run in Supabase SQL Editor if saving a service above 120 minutes fails.
-- Duration is capped at 8 hours (480 minutes); the app rounds values above
-- 120 to the closest 15-minute step before saving.
